...
<body>
  ...
  <section>
    ...
    <form action="" name="login" method="post">
      <div class="id">
        <input type="text" name="userEmail" id="userEmail" size="30" placeholder="이메일을 입력하세요.">
      </div>
      <div class="pw">
        <input type="text" name="userName" id="userName" size="45" placeholder="이름을 입력하세요.">
      </div>
      ...
      <div class="pw">
        <input type="text" name="pwCheck" id="pwCheck" size="45" placeholder="이메일 비빌번호를 입력하세요.">
      </div>
      
      <button type="button" onclick="checkBtn()">비밀번호 확인</button>
